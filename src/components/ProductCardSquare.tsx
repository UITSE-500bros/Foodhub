...
const ProductCardSquare = () => {
  return (
    <View className="flex w-[173] h-[250] flex-col justify-center items-center border rounded-2xl">
      <Image
        source={{ uri: "https://nutritionsource.hsph.harvard.edu/wp-content/uploads/2018/08/bananas-1354785_1920.jpg" }}
      ...
      <Text className=" text-[#7C7C7C] text-sm font-[900]  ">7 pieces, Price</Text>
      <View className=" items-center flex justify-around flex-row mt-7">
        <Text className=" mr-14 text-black text-lg font-semibold tracking-tighter">$4.99</Text>
        <AdjustButton
          type="plus"
